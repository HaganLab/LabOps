...
In practice, for most lab work you won't need to build your own containers — you'll pull existing, well-maintained images (e.g., from [nf-core](https://nf-co.re/) pipelines, which auto-pull the containers they need, or from [Bioconda](https://bioconda.github.io/)/[Biocontainers](https://biocontainers.pro/)) rather than writing your own `Dockerfile`. If you do want to build your own, the lab keeps a small collection of ready-to-use Docker images and Docker Compose setups (including a data-science/Jupyter starting point) in the [Containerization folder in LabCommons](https://github.com/HaganLab/LabCommons/tree/main/Containerization).
