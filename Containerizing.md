...
nf-core pipelines (see [Publishing](Publishing.html) for how we run nf-core/rnaseq) handle this pulling and execution automatically when you point Nextflow at the `singularity` profile — you generally don't need to do this manually unless you're troubleshooting or running a tool outside of an existing pipeline.
